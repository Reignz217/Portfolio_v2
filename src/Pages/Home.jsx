...
export default function Home() {
  return (
    <section id="home" className="flex flex-col justify-center items-center lg:mb-30 md:my-10 md:gap-8 scroll-mt-40">
        <img src="/Profile (1).jpg" alt="Profile Picture" loading='lazy' className="rounded-full lg:w-90 lg:h-90 md:w-70 md:h-70 w-80 aspect-square p-10 md:p-0 -mb-8 -mt-5 md:my-0"/>
